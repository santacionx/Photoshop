...
onload = function () {
    ...
    const tools = {
        ...
        "resize" : function(){
            let cols = editor.width; // Width is the number of columns
            let rows = editor.height; // Height is the number of rows
            let image = getRGBArray(rows, cols);
            ...
            tempCanvas.width = ncols;
            tempCanvas.height = nrows;
            tempContext.drawImage(editor, 0, 0, ncols, nrows);
        
            // Draw the resized image back to the editor canvas
            editor.width = ncols;
            editor.height = nrows;
            context.drawImage(tempCanvas, 0, 0, ncols, nrows);
        },
        "greyscale" : function(){
            let cols = editor.width; // Width is number of columns
            let rows = editor.height; // Height is number of rows
